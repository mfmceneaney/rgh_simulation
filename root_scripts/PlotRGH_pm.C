...
void PlotRGH_pm() {
    ...
    std::string skim_prefix = "skim_pm_"; // "skim_neg_";
    std::string particle_suffix = "_pm"; // "_pm";
    std::string particle_title_suffix = "_{p^{-}}"; // "_{negative track}";
    std::string extraname = "mc_rgh_pm"; // "mc_rgh_neg";
    ...
    // Open output file
    TFile *f = TFile::Open("PlotRGH_pm.root","RECREATE");
    f->cd();
