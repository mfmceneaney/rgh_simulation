...
void PlotRGH_pim() {
    ...
    std::string skim_prefix = "skim_pim_"; // "skim_neg_";
    std::string particle_suffix = "_pim"; // "_pm";
    std::string particle_title_suffix = "_{#pi^{-}}"; // "_{negative track}";
    std::string extraname = "mc_rgh_pim"; // "mc_rgh_neg";
    ...
    // Open output file
    TFile *f = TFile::Open("PlotRGH_pim.root","RECREATE");
    f->cd();
