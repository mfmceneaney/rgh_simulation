...
void PlotRGH_g() {
    ...
    std::string skim_prefix = "skim_g_"; // "skim_neg_";
    std::string particle_suffix = "_g"; // "_pm";
    std::string particle_title_suffix = "_{#gamma}"; // "_{negative track}";
    std::string extraname = "mc_rgh_g"; // "mc_rgh_neg";
    ...
    // Open output file
    TFile *f = TFile::Open("PlotRGH_g.root","RECREATE");
    f->cd();
