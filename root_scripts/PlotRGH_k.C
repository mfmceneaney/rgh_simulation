...
void PlotRGH_k() {
    ...
    std::string skim_prefix = "skim_k_"; // "skim_neg_";
    std::string particle_suffix = "_k"; // "_pm";
    std::string particle_title_suffix = "_{K^{+}}"; // "_{negative track}";
    std::string extraname = "mc_rgh_k"; // "mc_rgh_neg";
    ...
    // Open output file
    TFile *f = TFile::Open("PlotRGH_k.root","RECREATE");
    f->cd();
