...
void PlotRGH_pos() {
    ...
    std::string skim_prefix = "skim_pos_"; // "skim_neg_";
    std::string particle_suffix = "_p"; // "_pm";
    std::string particle_title_suffix = "_{positive track}"; // "_{negative track}";
    std::string extraname = "mc_rgh_pos"; // "mc_rgh_neg";
    ...
    // Open output file
    TFile *f = TFile::Open("PlotRGH_pos.root","RECREATE");
    f->cd();
