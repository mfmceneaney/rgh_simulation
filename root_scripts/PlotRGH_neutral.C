...
void PlotRGH_neutral() {
    ...
    std::string skim_prefix = "skim_neutral_"; // "skim_neg_";
    std::string particle_suffix = "_n"; // "_pm";
    std::string particle_title_suffix = "_{neutral track}"; // "_{negative track}";
    std::string extraname = "mc_rgh_neutral"; // "mc_rgh_neg";
    ...
    // Open output file
    TFile *f = TFile::Open("PlotRGH_neutral.root","RECREATE");
    f->cd();
    ...
    names.push_back("vT_e"); nbins.push_back(100); binlims.push_back({0.0,50.0}); labels.push_back("v_{T e^{-}} (cm)");
    names.push_back(Form("vT%s",particle_suffix.c_str())); nbins.push_back(100); binlims.push_back({0.0,50.0}); labels.push_back(Form("v_{T}%s (cm)",particle_title_suffix.c_str()));
