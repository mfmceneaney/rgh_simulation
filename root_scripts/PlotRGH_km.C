...
void PlotRGH_km() {
    ...
    std::string skim_prefix = "skim_km_"; // "skim_neg_";
    std::string particle_suffix = "_km"; // "_pm";
    std::string particle_title_suffix = "_{K^{-}}"; // "_{negative track}";
    std::string extraname = "mc_rgh_km"; // "mc_rgh_neg";
    ...
    // Open output file
    TFile *f = TFile::Open("PlotRGH_km.root","RECREATE");
    f->cd();
