...
void PlotRGH_n() {
    ...
    std::string skim_prefix = "skim_n_"; // "skim_neg_";
    std::string particle_suffix = "_n"; // "_pm";
    std::string particle_title_suffix = "_{n}"; // "_{negative track}";
    std::string extraname = "mc_rgh_n"; // "mc_rgh_neg";
    ...
    // Open output file
    TFile *f = TFile::Open("PlotRGH_n.root","RECREATE");
    f->cd();
